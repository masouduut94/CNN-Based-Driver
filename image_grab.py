...
# TODO: Handle the Problem when the process stops TODO: Check if it's possible to handle the [up,down,left,
#  right] with opencv.waitkey function and leave the combinations to pynput.
